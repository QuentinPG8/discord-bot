...
module.exports = class QueueCommand extends Command{
    constructor(client) {
        super(client, {
            ...
            group: 'musique',
            memberName: 'queue',
            description: "Affiche les musique dans la file d'attente. Pour afficher différentes pages, tape la commande avec le numéro de la page spécifié après (queue 2).",
            args: [
                {
                    key: 'page',
    ...
    async run(message,{ page }) {
        ...
        var embed = new MessageEmbed()
            ...
            .setColor("BLUE")
            .addField("En train d'écouter : " , `[${server.currentVideo.title}]` + `(${server.currentVideo.url})`);
